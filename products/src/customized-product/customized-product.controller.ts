...
//     @MessagePattern('PurchaseProduct.get.details')
//   async handleCustomizedProductDetails(@Payload() message) {
//     const { productId } = message.value;
//     return this.customizedProductService.getProductDetails(productId);
//   }
}
